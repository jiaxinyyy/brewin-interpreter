...
def generate_test_suite_v3():
    ...
    tests = [
        "test_default_field", "test_default_local",
        "test_str_ops",
        "test_template1", "test_template8", "test_template_multiple", #"test_template7",
        "test_except1", "test_except13",
        "test_except_while", "test_no_exception", "test_except_if", "test_except_while_condition", 
        "test_except_set",  "test_except4", #test_except_plus"
    ]
    fails = [
        "test_except4","test_template5", "test_template4",
        "test_template7", #"test_template_type",
        "test_incompat_template_types", "test_template_notype", "test_except_scope"
    ]
